...
def draw_window(surface, grid, score):
    ...
    label = font.render('Highscore : ' + str(read_score()), 1, (255, 255, 255))
...
def update_score(nscore):
    ...
    with open(os.path.join(sys.path[0], 'scores.txt'), 'w') as f:
        if int(score) > nscore:
            f.write(str(score))
        else:
            f.write(str(nscore))
...
# TODO
# - clear_rows is garbage !
# - increase level by piece placed not by time
# - position score and highscore properly
